 ...
 *                                                                  *
 * Tiedosto: cardslot.hh                                            *
 * Kuvaus: Cardslot luokan määrittely. Sisältää yhden cardslotin    *
 *         metodien määrittely sekä muita toiminnallisuuksia        *
 * Kommentit:                                                       *
 *                                                                  *
 *                                                                  *
 ********************************************************************
...
public:
    ...
    // Metodi joka asettaa kortille tiedon että pitääkö kortti piilottaa.
    void setHiding();
    // Metodi jolla voidaan tyhjentää CardSlot korteista
    void emptyCardSlot();
...
private:
    ...
    // Pelisääntöfunktio, joka määrittelee, mitä kortteja tähän widgettiin saa
    // raahata.
    CheckFunction checkFunction_;
    bool hiding_ = false;  // True jos kortin alla olevat kortit ei saa näkyä
};
