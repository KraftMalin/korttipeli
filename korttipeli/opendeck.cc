 ...
 *                                                                  *
 * Tieodsto: opendeck.cc                                            *
 * Kuvaus: Tämä on avoimen korttipakan private ja public metodien   *
 *         määrittely                                               *
 * Kommentit:                                                       *
 *                                                                  *
 *                                                                  *
...
// Metodi jolla voidaan poimia ylin kortti
...
void OpenDeck::emptyOpenDeck() {

}


// Slot jolla voidaan lisätä opendeckiin kortti
...
void OpenDeck::mousePressEvent(QMouseEvent *event) {
    ...
    // Luodaan mimeData-olio, jonka avulla raahattavan kortin tiedot
    // (=merkkijono) välitetään sinne, minne kortti raahataan.
    QMimeData *mimeData = new QMimeData;
    mimeData->setText(QString::fromStdString(card->getCardData()));

    // Luodaan drag-olio, jonka avulla raahaaminen tapahtuu. Drag-oliolle
    // annetaan raahauksen aikana näytettävä kuva, sekä tiedot raahattavasta
    // oliosta.
    QDrag *drag = new QDrag(this);
    drag->setMimeData(mimeData);
    drag->setPixmap(pixmap);
    // Se kohta raahattavasta kuvasta, jonka pitää osua kohteeseen.
